...
const0 db 'Hello, world! Calculating factorial using recursion :)', 0x00
const1 db 'Enter n in bounds [0, 12]:', 0x00
const2 db 'Error! Input value n=', 0x00
const3 db ' does not meet requirement!', 0x00
const4 db 'The factorial is n!=', 0x00
